...
while True:
    ...
    elif(state==1): #Tomar 30 datos continuos de Temp y Humedad
    ...
    elif(state==2): #Calcular el promedio de los datos
    ...
    elif(state==3): #Guardar datos promedio en el archivo y esperar 2 minutos para próxima medida
    ...
    elif(state==4):#Verificar la humedad para activar el HEATER y esperar 3 minutos para próxima medida
